...
export function ProviderActionDialog({
  ...
  const needsReason = reasonMode === "required" && reason.trim().length < 3;
        ...
        <div className="space-y-4 p-6">
          {reasonMode !== "none" ? (
            <label className="block text-sm font-medium">
              Reason{reasonMode === "required" ? " required" : " optional"}
              <textarea
                ...
                placeholder="Explain why this company action is needed."
                value={reason}
              />
            </label>
          ) : null}
          ...
          <div className="flex flex-wrap justify-end gap-2">
            ...
            <Button disabled={busy || needsReason} onClick={() => void confirmAction()} variant={variant === "destructive" ? "destructive" : "default"}>
